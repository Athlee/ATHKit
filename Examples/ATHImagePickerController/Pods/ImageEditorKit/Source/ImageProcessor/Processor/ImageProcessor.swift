...
public struct ImageProcessor: ImageProcessorType {
  ...
  public func process<T : Filter>(_ image: UIImage, filter: T, completion: @escaping (UIImage?) -> Void) {
    print("[ImageProcessor]: Unable to find appropriate processing method's overload...")
  }
  
  // MARK: BlurFilter
  
  public func process<T : BlurFilter>(_ image: UIImage,
               filter: T,
  ...
  public func process<T : TileEffect>(_ image: UIImage,
               filter: T,
               completion: @escaping (UIImage?) -> Void) {
    add(filter)
  ...
  public func process<T : ColorEffectFilter>(_ image: UIImage,
               filter: T,
               completion: @escaping (UIImage?) -> Void) {
    add(filter)
  ...
  public func process<T : ColorAdjustmentFilter>(_ image: UIImage,
               filter: T,
               completion: @escaping (UIImage?) -> Void) {
    add(filter)
  ...
  public func process<T : GeometryAdjustment>(_ image: UIImage,
               filter: T,
               completion: @escaping (UIImage?) -> Void) {
    add(filter)
  ...
  fileprivate func add<T : Filter>(_ filter: T) {
